            ...
            <div className="stack__container">
                ...
                <div className="stack__right">
                    <div className="stack__box__container">
                     ...
                     </div> {/*{end of stack box container} */}
                     {
                        props.stack.length > 4 ? (
                            <div className="stack__view__more">
                                ...
                                <div className={`stack__expand__box ${openStackExpandBar ? "open_stack_expand_box":""}`}>
             ...
             <div className="button__container">
                <a href={props.demoLink} target='blank' className="btn btn__primary">Demo</a>
